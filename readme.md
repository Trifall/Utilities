...
* ##### Text Editors - STOP USING NOTEPAD/WORDPAD
...
* PC Part Picker - [Website](https://pcpartpicker.com/) - If you are building a PC and not buying a pre-built. It will help you find the best parts for your budget, and will also help you find the best deals on parts. Detects parts that are compatible with other parts you have selected.
...
* have i been pwned? - [Website](https://haveibeenpwned.com/) - A website that allows you to check if your email address or password has been compromised in a data breach.
...
* CostPlusDrugs - [Website](https://www.costplusdrugs.com/) - A website that allows you to compare the prices of prescription drugs. You can search by drug name, or browse by category. Founded by Mark Cuban.
...
* Free Annual Credit Report - [https://www.annualcreditreport.com] - __MAKE SURE THE LINK IS CORRECT, WATCH OUT FOR SCAM SITES, YOU CAN EVEN GOOGLE IT JUST TO BE SAFE__. A website that allows you to get a free credit report from each of the three major credit bureaus. You can get one report every 12 months.  
...
* Regex Checkers - [Regex101](https://regex101.com/) / [RegExr](https://regexr.com/) / - Websites that allow you to test your regular expressions. You can test them against a string, and it will tell you if it matches.
...
* Diagrams<span>.net (formerly draw<span>.io) - [Website](https://app.diagrams.net/) - A website that allows you to create diagrams. It is free.
